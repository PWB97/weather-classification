...
class ModelOutputs():
    ...
    def __init__(self, model, target_layers, org_model):
        self.model = model
    ...
    def __call__(self, x):
        ...
        output = self.org_model.fc(output)
...
class GradCam:
    def __init__(self, model, target_layer_names, use_cuda, org_model=None):
        self.model = model
        self.model.eval()
        self.cuda = use_cuda
        if self.cuda:
        ...
        self.extractor = ModelOutputs(self.model, target_layer_names, org_model)
